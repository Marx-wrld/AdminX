...
export const tokens = (mode: ColorMode): ColorTokens => ({
    ...
    ? {
        ...
        //Use CTRL + SHIFT + P then select sort descending to sort the shades inversely
        grey: {
            100: "#141414",
            200: "#292929",
            300: "#3d3d3d",
...
//mui theme settings
//This returns the color tokens depending on the theme
...
//Creating a react  context for the color mode
